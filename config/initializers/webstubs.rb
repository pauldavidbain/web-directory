types = {
  person: [
    ...
    {id: 5, roles: ['student'], first_name: 'Michael', last_name: 'Annunziata', image_url: '', birthday: '06/07/1984', email: 'michael.z.anunziata@biola.edu', cell: '713-392-1482', major: 'Communication Studies', personal_email: 'annunziata@yahoo.com'},
    {id: 6, roles: ['alumni'],  first_name: 'Lucy', last_name: 'Durniok', image_url: '', email: 'lucy.durniok@biola.edu', personal_email: 'lucy1@adelphia.net', cell: '649-126-9485'},
